...
start() {
    ...
    (
        ...
        close_fds
        export GOGC=10
        setsid $exec --data-path /var/lib/imunify-nsqd --max-bytes-per-queue 104857600 --max-bytes-per-file 10485760 --use-unix-sockets --tcp-address /var/run/imunify-nsqd.sock --http-address /var/run/imunify-nsqd-http.sock &
    )
